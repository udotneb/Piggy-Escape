...
public class TETile implements Serializable {
     ...
     * @param description     The description of the tile, shown
     *                        in the GUI on hovering over the tile.
     * @param filepath        Full path to image to be used for this
     *                        tile. Must be correct size (16x16)
     */
     ...
     * @param textColor       The color of the character itself.
     * @param backgroundColor The color drawn behind the character.
     * @param description     The description of the tile, shown in the
     *                        GUI on hovering over the tile.
     */
    public TETile(char character, Color textColor, Color backgroundColor, String description) {
        this.character = character;
        this.textColor = textColor;
